/* CSCI 200: Lab 5A: L5A - Towers of Hanoi
 *
 * Author: Isaac March
 * Resources used (Office Hours, Tutoring, Other Students, etc & in what capacity):
 *     // Mathisfun, solving towers of hanoi
 *     // Kahn
 *
 * Automaticly solves and prints moves for towers of hanoi puzzle given a number of discs.
 */
